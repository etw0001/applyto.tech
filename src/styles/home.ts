...
export const modal = {
    ...
    sectionTitleDanger: "text-xs font-medium text-red-400/80 uppercase tracking-wider mb-3",
    ...
    deleteButton: "w-full flex items-center gap-3 px-3 py-3 rounded-lg bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 transition-colors text-left",
...
export const recommended = {
    ...
    clearButton: "absolute right-2 top-1/2 -translate-y-1/2 p-0.5 rounded text-muted-foreground hover:text-foreground",
...
export const form = {
    ...
    fieldInput: "bg-secondary/50 border-border text-sm h-9 placeholder:text-muted-foreground focus:border-ring focus:ring-0 transition-all",
    statusButton: "w-full flex items-center justify-between px-3 h-9 rounded-md bg-secondary/50 border border-border hover:border-ring transition-colors text-sm",
    ...
    submitButton: "bg-zinc-100 hover:bg-white text-zinc-900 h-8",
...
export const toolbar = {
    ...
    searchIcon: "absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground",
    searchInput: "pl-9 pr-8 bg-transparent border-border text-sm h-8 placeholder:text-muted-foreground focus:border-ring focus:ring-0",
    clearSearchButton: "absolute right-2 top-1/2 -translate-y-1/2 p-0.5 rounded text-muted-foreground hover:text-foreground",
    filterButton: (active: boolean) =>
        `flex items-center gap-2 px-3 h-8 rounded-md border text-sm transition-colors ${active ? "bg-secondary border-border text-foreground" : "bg-transparent border-border text-muted-foreground hover:text-foreground hover:border-ring"}`,
    sortButton: "flex items-center gap-2 px-3 h-8 rounded-md border border-border text-muted-foreground hover:text-foreground hover:border-ring text-sm transition-colors",
    ...
    addButton: "bg-violet-500 hover:bg-violet-600 text-white border-0 gap-1.5 font-medium text-sm h-8",
};
